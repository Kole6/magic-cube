...
<template>
  <div id="wrapper">
    <div class="conment" style="padding-bottom: 20px;">
      <div class="margin">
        <search-top :search="search" @clickbtn="handleBtn"></search-top>
      </div>
    </div>
    <card-wrapper button-name='专业综合指标得分'>
      <div id="radars"></div>
      <div class="curves">
    ...
    <div class="buttom">
      ...
      <div class="tables">
        <table width="100%" cellspacing="0" cellpadding="0" :data="tableData1">
          <tr><th>一级指标</th><th>分数</th><th>二级指标</th><th>三级指标</th><th>分数</th></tr>
...
import chartIm from "@/components/echart/chartIm2.vue";
export default {
  components:{
    cardWrapper,
    cardList,
